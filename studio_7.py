...
def main():
    ...
    filtered_average_salaries_by_indistries = []
    ...
    for group in average_salaries_by_industry:
        if group.participant_count >= 10:
            filtered_average_salaries_by_indistries.append(group)
    
    sorted_filitered_average_salary_by_industry = sorted(filtered_average_salaries_by_indistries, key = lambda x: x.average, reverse=True)
    top_5_industries = []
